...
5. Run full bootstrap (`make cluster-bootstrap ENV=<env> ESO_IRSA_ROLE_ARN=<arn>`).
6. ArgoCD reconciles child applications for `dev`, `stg`, and `prod` from `apps/children/`.
